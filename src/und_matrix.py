...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug  4 08:09:30 2021

This code is used to convert undefined dataset.
...
def fileConvert(input_file,mutsig_file):
    ...
    annotation.columns=['Annotation','Putative_impact','Type','NM','Biotype','Rank','HGVS.c','HGVS.p','cDNA','CDS','AA']
